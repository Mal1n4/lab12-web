<template>
    <div>
        <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white \">First
            name</label>
        <input type="text" id="first_name" v-model="store.firstname"
    ...
    <div>
        <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white \">Second
            name</label>
        <input type="text" id="first_name" v-model="store.secondname"
            class="bg-gray-50 border w-1/4 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Введите  вашую фамилию" required />
    </div>
    <button type="submit"  @:click="store.sendmessage()"
